...
function saltGun(p) {
  p.box(0.105, 0.21, 0.09, 0x0a5a6e, { pos: [0, 0.10, -0.02], rot: [-0.22, 0, 0] }); // deep teal grip
  p.box(0.14, 0.15, 0.34, 0x23e0c6, { pos: [0, 0.255, 0.06] });                      // mint body
  p.box(0.145, 0.045, 0.30, 0x0a5a6e, { pos: [0, 0.315, 0.06] });                    // teal ridge
  p.box(0.08, 0.055, 0.065, 0x0d6f82, { pos: [0, 0.20, 0.10] });                     // trigger guard
  p.cyl(0.058, 0.068, 0.22, 8, 0xeafffb, { pos: [0, 0.27, 0.28], rot: [Math.PI / 2, 0, 0] });
  p.cyl(0.09, 0.078, 0.05, 10, 0x0d6f82, { pos: [0, 0.27, 0.39], rot: [Math.PI / 2, 0, 0] });
  p.cyl(0.10, 0.09, 0.19, 10, 0xf6ffff, { pos: [0, 0.41, -0.02], glow: 0.75 });      // salt canister
  p.cyl(0.105, 0.105, 0.03, 10, 0x0d6f82, { pos: [0, 0.51, -0.02] });
  for (let i = 0; i < 5; i++) p.tet(0.036, 0xffffff, { pos: [(i % 2 ? 0.045 : -0.045), 0.43 + i * 0.022, -0.02 + (i - 2) * 0.022], rot: [i, i * 2, 0], glow: 1.0 });
  p.box(0.055, 0.035, 0.055, 0x00d9ff, { pos: [0, 0.345, 0.20], glow: 0.9 });        // charge light
}
...
export const VISUALS = {
  ...
  salt: { build: saltShaker, halo: 0.34, gloss: true, pick: 2.3, tilt: [0.06, 0, 0.09], lift: 0.90, hue: 0x5fd8ff, mark: 1.25, hold: { pos: [0, -0.30, 0.04], rot: [2.55, 0, 0], scale: 1 } },
  bat: { build: candyBat, halo: 0.32, gloss: true, pick: 1.62, tilt: [0.0, 0, 0.62], lift: 0.78, hue: 0xff2d4a, mark: 1.25, hold: { pos: [0, -0.26, 0.05], rot: [2.35, 0, 0.12], scale: 1 } },
  slingshot: { build: slingshot, halo: 0.32, gloss: true, pick: 2.3, tilt: [0.08, 0, 0.09], lift: 0.89, hue: 0xffa22a, mark: 1.25, hold: { pos: [0, -0.28, 0.05], rot: [2.5, 0, 0], scale: 1 } },
  spritzer: { build: spritzer, halo: 0.34, gloss: true, pick: 2.35, tilt: [0.08, 0, 0.10], lift: 0.90, hue: 0xffe23a, mark: 1.25, hold: { pos: [0, -0.28, 0.04], rot: [2.55, 0, 0], scale: 1 } },
  spray: { build: sprayBottle, halo: 0.34, gloss: true, pick: 2.3, tilt: [0.06, 0, 0.09], lift: 0.89, hue: 0x3fe4ff, mark: 1.25, hold: { pos: [0, -0.28, 0.03], rot: [2.62, 0, 0], scale: 1 } },
  saltgun: { build: saltGun, halo: 0.36, gloss: true, pick: 2.35, tilt: [0.05, 0, 0.18], lift: 0.90, hue: 0x4fe8d8, mark: 1.25, hold: { pos: [0, -0.27, 0.04], rot: [2.30, 0, 0], scale: 1 } },
  caramelizer: { build: caramelizer, halo: 0.38, gloss: true, pick: 2.3, tilt: [0.05, 0, 0.20], lift: 0.89, hue: 0xff8a14, mark: 1.3, hold: { pos: [0, -0.27, 0.04], rot: [2.25, 0, 0], scale: 1 } },
